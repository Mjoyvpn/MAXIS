...
SNPID=https://raw.githubusercontent.com/Mjoyvpn/MAXIS/main
...
echo "IP=" >> /var/lib/maxisvpn-pro/ipvps.conf
...
echo "IP=$pp" > /var/lib/maxisovpn-pro/ipvps.conf

#THEME RED
cat <<EOF>> /etc/maxisovpn/theme/red
BG : \E[40;1;41m
TEXT : \033[0;31m
EOF
#THEME BLUE
cat <<EOF>> /etc/maxisovpn/theme/blue
BG : \E[40;1;44m
TEXT : \033[0;34m
EOF
#THEME GREEN
cat <<EOF>> /etc/maxisovpn/theme/green
BG : \E[40;1;42m
TEXT : \033[0;32m
EOF
#THEME YELLOW
cat <<EOF>> /etc/maxisovpn/theme/yellow
BG : \E[40;1;43m
TEXT : \033[0;33m
EOF
#THEME MAGENTA
cat <<EOF>> /etc/maxisovpn/theme/magenta
BG : \E[40;1;43m
TEXT : \033[0;33m
EOF
#THEME CYAN
cat <<EOF>> /etc/maxisovpn/theme/cyan
BG : \E[40;1;46m
TEXT : \033[0;36m
EOF
#THEME CONFIG
cat <<EOF>> /etc/maxisovpn/theme/color.conf
blue
EOF
