...
APIGIT=$(cat /etc/maxisovpn/github/api)
EMAILGIT=$(cat /etc/maxisovpn/github/email)
USERGIT=$(cat /etc/maxisovpn/github/username)
...
if [[ -f /etc/maxisovpn/github/api && -f /etc/maxisovpn/github/email && /etc/maxisovpn/github/username ]]; then
   rec="OK"
else
    mkdir /etc/maxisovpn/github > /dev/null 2>&1
fi
...
sleep 2
echo "$EMAIL1" > /etc/maxisovpn/github/email
echo "$USERNAME1" > /etc/maxisovpn/github/username
echo "$API1" > /etc/maxisovpn/github/api
echo "ON" > /etc/maxisovpn/github/gitstat
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
function resetipvps(){
clear
rm -f /etc/maxisovpn/github/email
rm -f /etc/maxisovpn/github/username
rm -f /etc/maxisovpn/github/api
rm -f /etc/maxisovpn/github/gitstat
echo "OFF" > /etc/maxisovpn/github/gitstat
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
echo -e "$COLOR1│${NC} [INFO] PM : t.me/joysmark"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}              • JOY SMARK •            $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
GITREQ=/etc/maxisovpn/github/gitstat
if [ -f "$GITREQ" ]; then
    cekk="ok"
else 
    mkdir /etc/maxisovpn/github
    touch /etc/maxisovpn/github/gitstat
    echo "OFF" > /etc/maxisovpn/github/gitstat
fi

stst1=$(cat /etc/maxisovpn/github/gitstat)
if [ "$stst1" = "OFF" ]; then
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1│${NC} ${COLBG1}               • REGISTER IPVPS •              ${NC} $COLOR1│$NC"
...
stst=$(cat /etc/maxisovpn/github/gitstat)
if [ "$stst" = "ON" ]; then
APIOK="CEK API"
rex="viewapi"
else
